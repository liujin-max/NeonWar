...
{
    public static string UI_UPDATEFOOD      = "UI_UPDATEFOOD";
    ...
    public static string UI_UPDATESCORE     = "UI_UPDATESCORE";
    public static string UI_UPDATETASK      = "UI_UPDATETASK";
    public static string UI_UPDATEPROPS     = "UI_UPDATEPROPS";
    public static string UI_FLYCOIN         = "UI_FLYCOIN";
    public static string UI_SHOWOPT         = "UI_SHOWOPT";
    public static string UI_FLUSHRANKS      = "UI_FLUSHRANKS";
