...
public class Crit : MonoBehaviour
{
    ...
    void Shake()
    {
        ...
        m_ShakeTweeners.Add(m_Text2.transform.DOShakePosition(0.6f, new Vector3(0.2f, 0.2f, 0), 50, 50).SetAutoKill(false));
        m_ShakeTweeners.Add(m_Text3.transform.DOShakePosition(0.6f, new Vector3(0.2f, 0.2f, 0), 50, 50).SetAutoKill(false));
        m_ShakeTweeners.Add(m_Text4.transform.DOShakePosition(0.6f, new Vector3(0.2f, 0.2f, 0), 50, 50).SetAutoKill(false));
