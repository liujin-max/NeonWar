...
public class Crit : MonoBehaviour
{
    ...
    void Shake()
    {
        ...
        m_Text2.transform.DOShakePosition(0.6f, new Vector3(0.12f, 0.12f, 0), 50, 50);
        m_Text3.transform.DOShakePosition(0.6f, new Vector3(0.12f, 0.12f, 0), 50, 50);
        m_Text4.transform.DOShakePosition(0.6f, new Vector3(0.12f, 0.12f, 0), 50, 50);
